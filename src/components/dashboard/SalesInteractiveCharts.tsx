...
export const SalesInteractiveCharts: React.FC<SalesInteractiveChartsProps> = ({
  data
}) => {
      ...
      case 'products':
        return <div className="space-y-4">
            <div className="flex gap-2 flex-wrap">
              <Button variant={productMetric === 'revenue' ? 'default' : 'outline'} size="sm" onClick={() => handleProductMetricChange('revenue')}>
                Revenue
              </Button>
              <Button variant={productMetric === 'transactions' ? 'default' : 'outline'} size="sm" onClick={() => handleProductMetricChange('transactions')}>
                Transactions
              </Button>
              <Button variant={productMetric === 'customers' ? 'default' : 'outline'} size="sm" onClick={() => handleProductMetricChange('customers')}>
                Customers
              </Button>
              <Button variant={productMetric === 'units' ? 'default' : 'outline'} size="sm" onClick={() => handleProductMetricChange('units')}>
                Units Sold
              </Button>
            </div>
            <ResponsiveContainer width="100%" height={400}>
              <BarChart data={topProductsData} margin={{
              left: 20,
              right: 20,
              top: 20,
              bottom: 60
